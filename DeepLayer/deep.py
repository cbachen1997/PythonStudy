# -*- coding: utf-8 -*-
"""
Created on Thu Aug  6 10:10:52 2020
...
def linear_activation_forward(A_prev,W,b,activation):
    ...
    """
    #判断激活函数
    #返回A(激活函数值)和Z(=activation_cache)线性结果
    ...
    #linear_cache中包含上一层的A,该层W,b,activation_cache包含该层的Z
...
def L_model_forward(X,parameters):
    ...
    caches=[]  
    A=X
    L=len(parameters)//2#层数(W,b除以二)
    for l in range(1,L):
        A_prev=A
        #传入前一层的A，该层的W,b,和激活函数
        A,cache=linear_activation_forward(A_prev,parameters['W'+str(l)],parameters['b'+str(l)],'relu')
        #缓存每一层的线性参数和结果
        #cache:linear_cache中包含上一层的A,该层W,b,activation_cache包含该层的Z
        caches.append(cache)
